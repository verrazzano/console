...
export class LoginPage {
    ...
    public async login(loginInfo: LoginInfo, acceptCookies?: boolean, timeout?: number) {
        console.log("Performing Keycloak Login");
        const isUsernameBoxPresent = await Wait.waitForPresent(LoginPage.USERNAME_BY).then(() => true).catch(() => false);
