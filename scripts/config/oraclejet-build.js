...
module.exports = function () {
  return {
     ...
     * Example:
     * copyCustomLibsToStaging: {
     *    fileList: [{cwd: 'app', src: ['**', '!test.js'], dest: 'staging',  rename: function (dest, file) {return renamed path}}]
     * }
     */
    /**
     * # copySrcToStaging
     ...
     * Example: copySrcToStaging: { fileList: [] }
     */
    /**
     * # injectTheme
     ...
     * Example:
     * hybrid: { copyCustomLibsToStaging: { ... } }
     */
  };
};
