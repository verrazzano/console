    ...
    return (
      <div>
        <ConsoleMetadataItem
          ...
          value={
            this.props.vmiInstances.find((link: VMI) => link.type === VMIType.Kibana).url
          }
          link={true}
        />
        <ConsoleMetadataItem
          ...
          value={
            this.props.vmiInstances.find((link: VMI) => link.type === VMIType.Grafana).url
          }
          link={true}
        />
        <ConsoleMetadataItem
          ...
          value={
            this.props.vmiInstances.find((link: VMI) => link.type === VMIType.Prometheus)
              .url
          }
          link={true}
        />
