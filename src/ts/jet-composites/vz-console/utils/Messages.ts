...
export const Footer = {
    ...
    yourPrivacyRights : () => Translations.getTranslatedString('footer.yourPrivacyRights'),
}
...
export const Instance = {
    ...
    instancePageLoaded : () => Translations.getTranslatedString('instance.instancePageLoaded'),
    instanceHeading : () => Translations.getTranslatedString('instance.instanceHeading'),
...
export const Binding = {
    bindingsPageLoaded : () => Translations.getTranslatedString('binding.bindingsPageLoaded'),
    heading : () => Translations.getTranslatedString('binding.heading'),
    telemetry: () => Translations.getTranslatedString('binding.telemetry'),
}

export const Model = {
    modelsPageLoaded : () => Translations.getTranslatedString('model.modelsPageLoaded'),
    heading : () => Translations.getTranslatedString('model.heading'),
}

export const Error = {
    errSendAuthReq : (...args) => Translations.getTranslatedString('error.errSendAuthReq', args),
    errAccessToken : (...args) => Translations.getTranslatedString('error.errAccessToken', args),
    errRefreshToken : (...args) => Translations.getTranslatedString('error.errRefreshToken', args),
    errLoggingOut : (...args) => Translations.getTranslatedString('error.errLoggingOut', args),
    errCallKeyCloak : (...args) => Translations.getTranslatedString('error.errCallKeyCloak', args),
    errFetchFailed : (...args) => Translations.getTranslatedString('error.errFetchFailed', args),

    errInvalidBindingId : (...args) => Translations.getTranslatedString('error.errInvalidBindingId', args),
    errRenderBinding : (...args) => Translations.getTranslatedString('error.errRenderBinding', args),

    errRenderBindingComponents : (...args) => Translations.getTranslatedString('error.errRenderBindingComponents', args),

    errRenderBindingList : (...args) => Translations.getTranslatedString('error.errRenderBindingList', args),
    errRenderBindingTelemetry : (...args) => Translations.getTranslatedString('error.errRenderBindingTelemetry', args),

    errRenderConnectionList : (...args) => Translations.getTranslatedString('error.errRenderConnectionList', args),
    errRenderIngList : (...args) => Translations.getTranslatedString('error.errRenderIngList', args),

    errRenderInstance : (...args) => Translations.getTranslatedString('error.errRenderInstance', args),

    errInvalidModelId : (...args) => Translations.getTranslatedString('error.errInvalidModelId', args),
    errRenderModel : (...args) => Translations.getTranslatedString('error.errRenderModel', args),

    errRenderModelComponents : (...args) => Translations.getTranslatedString('error.errRenderModelComponents', args),

    errRenderModelList : (...args) => Translations.getTranslatedString('error.errRenderModelList', args),

    errRenderSecretList : (...args) => Translations.getTranslatedString('error.errRenderSecretList', args),
}

export const Auth = {
    msgAuthInit : () => Translations.getTranslatedString('auth.msgAuthInit'),
    msgTokenNotInStorage : () => Translations.getTranslatedString('auth.msgTokenNotInStorage'),
    msgLogInKeyCloak : () => Translations.getTranslatedString('auth.msgLogInKeyCloak'),
    msgGetAccessToken : () => Translations.getTranslatedString('auth.msgGetAccessToken'),
    msgAuthEnabled : (...args) => Translations.getTranslatedString('auth.msgAuthEnabled', args),
    msgUiUrl : (...args) => Translations.getTranslatedString('auth.msgUiUrl', args),
}
...
export const Api = {
    msgFetchBinding: (...args) => Translations.getTranslatedString('api.msgFetchBinding',args),
    msgFetchModel : (...args) => Translations.getTranslatedString('api.msgFetchModel',args),
