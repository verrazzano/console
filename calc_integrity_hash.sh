...
#
set -x
echo "Calculating integrity hash for static resources"
...
UNIXFONT_CSS_HASH=$(echo sha384-$(curl -sS --ipv4 https://static.oracle.com/cdn/fnd/gallery/2110.2.0/images/iconfont/ojuxIconFont.min.css | openssl dgst -sha384 -binary | openssl base64 -A))
